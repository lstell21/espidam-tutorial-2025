...
- `n_runs::Int`: The number of simulation runs (seeds) to generate. Default is 100.
...
# Example
```julia
mdf = run_simulations(network_type=:random, mean_degree=4, patient_zero=:random, high_risk=:random, fraction_high_risk=1.0, n_runs=50)
```
"""
function run_simulations(; network_type::Symbol, mean_degree::Int, n_nodes::Int=1000, 
                        n_runs::Int=100, dispersion::Float64=0.1, patient_zero::Symbol=:random, 
